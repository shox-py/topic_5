...
* Преобразование словаря в множество с использованием `set()` и `frozenset()`
...
Функции `all()` и `any()` могут работать только с элементами, которые могут быть интерпретированы как логические
